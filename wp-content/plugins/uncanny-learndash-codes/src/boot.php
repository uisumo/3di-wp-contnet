...
class Boot extends Config {
	...
	public function initialize_internal_classes( $uncanny_learndash_codes ) {
		...
		include_once 'classes/integrations/class-learndash.php';
		$uncanny_learndash_codes->learndash = new LearnDash;

		// Add Woocommerce Functions!
		include_once 'classes/integrations/class-woocommerce.php';
		...
		include_once 'classes/integrations/class-gravity-forms.php';
		...
		// Add CSV Functions!
		include_once 'classes/integrations/class-theme-my-login.php';
		$uncanny_learndash_codes->theme_my_login = new ThemeMyLogin;

		// Add Gravity Forms Code Field Functions!
		include_once 'classes/integrations/class-gravity-forms-code-field.php';
		...
		// Add Gravity Forms Code Field Functions!
		include_once 'classes/integrations/class-wpforms.php';
		...
		include_once 'classes/integrations/class-formidable.php';
		...
		// Adding Classes!
		include_once 'classes/integrations/class-woo-automator-codes.php';
	...
	public static function uo_codes_admin_scripts() {
		...
		wp_register_script( 'uncanny-learndash-codes-backend', Config::get_asset( 'backend', 'bundle.min.js' ), array(
			'jquery',
			'uoc-select2',
		), Config::get_version() );
	...
	public static function uo_plugin_updater() {
		...
		// setup the updater.
		new EDD_SL_Plugin_Updater( UO_CODES_STORE_URL, UO_CODES_FILE, array(
	...
	public static function uo_license_menu() {
		...
		add_submenu_page( 'uncanny-learndash-codes', esc_html__( 'Uncanny Codes License Activation', 'uncanny-learndash-codes' ), esc_html__( 'License activation', 'uncanny-learndash-codes' ), 'manage_options', 'uncanny-codes-license-activation', array(
			__CLASS__,
			'uo_license_page',
		) );
