...
class Wrapper
{
    ...
    {
        $namespace IWLib\= '\\PhpXmlRpc\\';
        $reqClass = $namespace IWLib\. 'Request';
        $valClass = $namespace IWLib\. 'Value';
        $decoderClass = $namespace IWLib\. 'Encoder';
    ...
    protected function buildWrapMethodClosure($client, $methodName, array $extraOptions, $mSig)
    {
        ...
        $function = function() use($clientClone, $methodName, $extraOptions, $mSig)
        {
            ...
            $namespace IWLib\= '\\PhpXmlRpc\\';
            $reqClass = $namespace IWLib\. 'Request';
            $encoderClass = $namespace IWLib\. 'Encoder';
            $valueClass = $namespace IWLib\. 'Value';
     ...
     * @param string $namespace IWLib\*
     * @return string
     */
    protected function buildClientWrapperCode($client, $verbatimClientCopy, $prefix = 'xmlrpc', $namespace IWLib\= '\\PhpXmlRpc\\' )
    {
