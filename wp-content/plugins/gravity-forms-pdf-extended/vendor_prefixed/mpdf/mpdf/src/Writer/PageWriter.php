...
final class PageWriter
{
    ...
    public function __construct(\GFPDF_Vendor\Mpdf\Mpdf $mpdf, \GFPDF_Vendor\Mpdf\Form $form, \GFPDF_Vendor\Mpdf\Writer\BaseWriter $writer, \GFPDF_Vendor\Mpdf\Writer\MetadataWriter $metadataWriter)
    {
        $this->mpdf = $mpdf;
        $this->form = $form;
        $this->writer = $writer;
    ...
    public function writePages()
    {
        ...
        for ($n = 1; $n <= $nb; $n++) {
            ...
            if (isset($this->mpdf->OrientationChanges[$n])) {
                $hPt = $this->mpdf->pageDim[$n]['w'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $wPt = $this->mpdf->pageDim[$n]['h'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $owidthPt_LR = $this->mpdf->pageDim[$n]['outer_width_TB'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $owidthPt_TB = $this->mpdf->pageDim[$n]['outer_width_LR'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
            } else {
                $wPt = $this->mpdf->pageDim[$n]['w'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $hPt = $this->mpdf->pageDim[$n]['h'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $owidthPt_LR = $this->mpdf->pageDim[$n]['outer_width_LR'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $owidthPt_TB = $this->mpdf->pageDim[$n]['outer_width_TB'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
            }
            ...
            if (isset($this->mpdf->OrientationChanges[$n])) {
                ...
                $bleedMargin = $this->mpdf->pageDim[$n]['bleedMargin'] * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
