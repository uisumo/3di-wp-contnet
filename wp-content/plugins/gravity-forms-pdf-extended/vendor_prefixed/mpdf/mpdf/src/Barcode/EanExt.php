 ...
 */
class EanExt extends \GFPDF_Vendor\Mpdf\Barcode\AbstractBarcode implements \GFPDF_Vendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
     * @param int $length
    ...
    private function init($code, $length = 5)
    {
        ...
        if ($length == 2) {
            ...
            throw new \GFPDF_Vendor\Mpdf\Barcode\BarcodeException(\sprintf('Invalid EAN barcode value "%s"', $code));
        }
