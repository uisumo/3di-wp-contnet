...
class PageFooter extends \GFPDF_Vendor\Mpdf\Tag\Tag
{
    public function open($attr, &$ahtml, &$ihtml)
    {
        ...
        if (isset($attr['HEADER-STYLE']) || isset($attr['FOOTER-STYLE'])) {
            ...
            if (isset($properties['FONT-SIZE'])) {
                $p['L']['font-size'] = $this->sizeConverter->convert($properties['FONT-SIZE']) * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $p['C']['font-size'] = $this->sizeConverter->convert($properties['FONT-SIZE']) * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
                $p['R']['font-size'] = $this->sizeConverter->convert($properties['FONT-SIZE']) * \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
            }
