...
class Legend extends \GFPDF_Vendor\Mpdf\Tag\Tag
{
    ...
    public function close(&$ahtml, &$ihtml)
    {
        if (\count($this->mpdf->textbuffer) && !$this->mpdf->tableLevel) {
            ...
            $this->mpdf->blk[$this->mpdf->blklvl]['margin_top'] += $leg[11] / 2 / \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
            $this->mpdf->blk[$this->mpdf->blklvl]['padding_top'] += $leg[11] / 2 / \GFPDF_Vendor\Mpdf\Mpdf::SCALE;
        }
