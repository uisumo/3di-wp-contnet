...
trait FpdiTrait
{
     ...
     */
    protected function getPdfParserInstance(\GFPDF_Vendor\setasign\Fpdi\PdfParser\StreamReader $streamReader)
    {
        ...
        if (\class_exists(\GFPDF_Vendor\setasign\FpdiPdfParser\PdfParser\PdfParser::class)) {
            /** @noinspection PhpUndefinedClassInspection */
            return new \GFPDF_Vendor\setasign\FpdiPdfParser\PdfParser\PdfParser($streamReader);
        }
    ...
    protected function getPdfReaderId($file)
    {
        ...
        $reader = new \GFPDF_Vendor\setasign\Fpdi\PdfReader\PdfReader($this->getPdfParserInstance($streamReader));
        /** @noinspection OffsetOperationsInspection */
