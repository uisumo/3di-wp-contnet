...
use GFPDF_Vendor\Masterminds\HTML5\Entities;
/**
...
class CharacterReference
{
    ...
    public static function lookupName($name)
    {
        ...
        return isset(\GFPDF_Vendor\Masterminds\HTML5\Entities::$byName[$name]) ? \GFPDF_Vendor\Masterminds\HTML5\Entities::$byName[$name] : null;
    }
    /**
