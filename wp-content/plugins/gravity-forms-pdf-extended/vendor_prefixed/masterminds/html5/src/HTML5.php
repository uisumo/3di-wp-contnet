...
namespace GFPDF_Vendor\Masterminds;

use GFPDF_Vendor\Masterminds\HTML5\Parser\DOMTreeBuilder;
use GFPDF_Vendor\Masterminds\HTML5\Parser\Scanner;
use GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer;
use GFPDF_Vendor\Masterminds\HTML5\Serializer\OutputRules;
use GFPDF_Vendor\Masterminds\HTML5\Serializer\Traverser;
/**
...
class HTML5
{
    ...
    public function parse($input, array $options = array())
    {
        ...
        $events = new \GFPDF_Vendor\Masterminds\HTML5\Parser\DOMTreeBuilder(\false, $options);
        $scanner = new \GFPDF_Vendor\Masterminds\HTML5\Parser\Scanner($input, !empty($options['encoding']) ? $options['encoding'] : 'UTF-8');
        $parser = new \GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer($scanner, $events, !empty($options['xmlNamespaces']) ? \GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer::CONFORMANT_XML : \GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer::CONFORMANT_HTML);
        $parser->parse();
    ...
    {
        $options = \array_merge($this->defaultOptions, $options);
        $events = new \GFPDF_Vendor\Masterminds\HTML5\Parser\DOMTreeBuilder(\true, $options);
        $scanner = new \GFPDF_Vendor\Masterminds\HTML5\Parser\Scanner($input, !empty($options['encoding']) ? $options['encoding'] : 'UTF-8');
        $parser = new \GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer($scanner, $events, !empty($options['xmlNamespaces']) ? \GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer::CONFORMANT_XML : \GFPDF_Vendor\Masterminds\HTML5\Parser\Tokenizer::CONFORMANT_HTML);
        $parser->parse();
        $this->errors = $events->getErrors();
    ...
    public function save($dom, $file, $options = array())
    {
        ...
        $options = \array_merge($this->defaultOptions, $options);
        $rules = new \GFPDF_Vendor\Masterminds\HTML5\Serializer\OutputRules($stream, $options);
        $trav = new \GFPDF_Vendor\Masterminds\HTML5\Serializer\Traverser($dom, $stream, $rules, $options);
        $trav->walk();
        /*
