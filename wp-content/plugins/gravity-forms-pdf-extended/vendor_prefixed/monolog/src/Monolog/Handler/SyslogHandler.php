...
class SyslogHandler extends \GFPDF_Vendor\Monolog\Handler\AbstractSyslogHandler
{
    ...
    protected function write(array $record) : void
    {
        if (!\openlog($this->ident, $this->logopts, $this->facility)) {
            throw new \LogicException('Can\'t open syslog for ident "' . $this->ident . '" and facility "' . $this->facility . '"' . \GFPDF_Vendor\Monolog\Utils::getRecordMessageForException($record));
        }
