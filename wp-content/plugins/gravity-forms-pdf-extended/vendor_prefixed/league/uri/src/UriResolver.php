...
final class UriResolver
{
    ...
    public static function resolve($uri, $base_uri)
    {
        ...
        $null = $uri instanceof \Psr\Http\Message\UriInterface ? '' : null;
    ...
    private static function resolvePathAndQuery($uri, $base_uri) : array
    {
        ...
        $null = $uri instanceof \Psr\Http\Message\UriInterface ? '' : null;
        $baseNull = $base_uri instanceof \Psr\Http\Message\UriInterface ? '' : null;
    ...
    private static function getComponent(string $method, $uri) : ?string
    {
        ...
        if ($uri instanceof \Psr\Http\Message\UriInterface && '' === $component) {
            return null;
        }
        return $component;
    }
