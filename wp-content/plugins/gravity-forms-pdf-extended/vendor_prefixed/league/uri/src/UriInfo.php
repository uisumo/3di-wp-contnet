...
final class UriInfo
{
    ...
    {
        return $uri instanceof \Psr\Http\Message\UriInterface ? '' : null;
    }
    /**
    ...
    {
        if ($uri instanceof \Psr\Http\Message\UriInterface || $uri instanceof \GFPDF_Vendor\League\Uri\Contracts\UriInterface) {
            return $uri;
        }
    ...
    public static function isSameDocument($uri, $base_uri) : bool
    {
        ...
        return (string) $uri->withFragment($uri instanceof \Psr\Http\Message\UriInterface ? '' : null) === (string) $base_uri->withFragment($base_uri instanceof \Psr\Http\Message\UriInterface ? '' : null);
    }
    /**
