	...
	public function premium_info( $section_and_perm_type ) {
		...
		$premium_features = '
			...
			<div class="ewd-upcp-dashboard-new-footer-one-buttons">
				<a class="ewd-upcp-dashboard-new-upgrade-button" href="https://www.etoilewebdesign.com/license-payment/?Selected=UPCP&Quantity=1" target="_blank">' . __( 'UPGRADE NOW', 'ultimate-product-catalogue' ) . '</a>
			</div>
		';
