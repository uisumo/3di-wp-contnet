...
const UNCANNY_GROUPS_VERSION     = '4.3';
/**
 *
 */
const UNCANNY_GROUPS_DB_VERSION  = '4.0';
/**
 *
 */
...
include_once __DIR__ . '/src/classes/handlers/class-db-handler.php';
include_once __DIR__ . '/src/classes/handlers/class-group-management-db-handler.php';
/**
 * param DB_Handler
 */
 ...
 * @deprecated v4.0.
 */
include_once ULGM_ABSPATH . 'src' . DIRECTORY_SEPARATOR . 'classes/class-initialize-plugin.php';
// Generate DB Tables and Group Management pages
include_once ULGM_ABSPATH . 'src' . DIRECTORY_SEPARATOR . 'classes/class-setup.php';
Setup::get_instance();

// Add global functions
include_once ULGM_ABSPATH . 'src' . DIRECTORY_SEPARATOR . 'global-functions.php';
...
if ( defined( 'LEARNDASH_VERSION' ) ) {
	...
	function uo_groups_learndash_not_activated() {
		...
		<div class="notice notice-error">
			<h4>
				<?php echo __( 'Warning: Uncanny Groups for LearnDash requires LearnDash. Please install LearnDash before using the plugin.', 'uncanny-learndash-groups' ); ?>
			</h4>
		</div>
		<?php
	}
