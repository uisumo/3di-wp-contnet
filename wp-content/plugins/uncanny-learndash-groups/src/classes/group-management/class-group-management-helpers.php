...
class Group_Management_Helpers {
	 ...
	 * @return array|string
	 */
	public static function get_headers( $group_users_email = false, $group_leader_details = array() ) {
	...
	/**
	 * Generates an html anchor link that user can click to generate their password.
	 *
