...
//			if ( '' !== get_post_meta( $_product->get_id(), '_ulgm_bulk_discount_enabled', true ) && 'yes' !== get_post_meta( $_product->get_id(), '_ulgm_bulk_discount_enabled', true ) ) {
//				continue;
//			}
//			$license_cost = SharedFunctions::get_custom_product_price( $_product );
//
