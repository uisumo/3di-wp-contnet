		...
		<div class="ulgm-admin-content">
			<div class="uo-ulgm-admin form-table group-management-form">
					...
					<div class="uo-admin-block">
						<div class="uo-admin-form">
							...
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_management_page']; ?>
									<a href="https://www.uncannyowl.com/knowledge-base/set-group-management-pages/?utm_medium=uo_groups&utm_campaign=settings_page"
									   target="_blank"><span class="dashicons dashicons-info"></span></a>
								</div>
								<?php
								wp_dropdown_pages(
									array(
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>
							...
							<!-- Buy Courses Page -->
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_buy_courses_page']; ?>
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups_buy_courses] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>

							<!-- Group Report Page -->
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_report_page']; ?>
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups_course_report] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>

							<!-- Group Quiz Report Page -->
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_quiz_report_page']; ?>
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups_quiz_report] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>

							<!-- Group Progress Management Report Page -->
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_manage_progress_page']; ?>
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups_manage_progress] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>

							<!-- Allow Group Leaders to Manage Progress -->
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="allow_group_leaders_to_manage_progress"
							...
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_assignment_report_page']; ?>
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups_assignments] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>

							<!-- Group Essay Report Page -->
							<div class="uo-admin-field">
								<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['ulgm_group_essay_report_page']; ?>
								...
								?>
								<div class="uo-admin-description"><?php _e( 'Choose a page that includes the [uo_groups_essays] shortcode.', 'uncanny-learndash-groups' ); ?></div>
							</div>
				...
				<div class="uo-admin-section">
					<div class="uo-admin-header">
						<div class="uo-admin-title"><?php echo AdminPage::$ulgm_management_admin_page['text']['page_settings_general']; ?></div>
					</div>
					<div class="uo-admin-block">
						<div class="uo-admin-form">
							...
							<div class="uo-admin-field">
								...
								<input class="uo-admin-input" type="text" name="ulgm_per_seat_text"
							...
							<div class="uo-admin-field">
								...
								<input class="uo-admin-input" type="text" name="ulgm_per_seat_text_plural"
							...
							<div class="uo-admin-field">
								...
								<input type="text" name="ulgm_main_color" id="ulgm_main_color"
							...
							<div class="uo-admin-field">
								...
								<input type="text" name="ulgm_font_color" id="ulgm_font_color"
									   value="<?php echo AdminPage::$ulgm_management_admin_page['ulgm_font_color']; ?>"/>
								<div class="uo-admin-description"><?php echo __( 'The color of the text that appears on top of accented areas.', 'uncanny-learndash-groups' ); ?></div>
							</div>
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="allow_to_remove_users_anytime"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="do_not_restore_seat_if_user_is_removed"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="group_leaders_dont_use_seats"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="do_not_add_group_leader_as_member"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="allow_group_leader_edit_users"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="allow_group_leader_change_username"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="use_progress_report_instead_course"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="show_basic_groups_in_frontend"
				...
				<div class="uo-admin-section">
					<div class="uo-admin-header">
						<div class="uo-admin-title"><?php echo AdminPage::$ulgm_management_admin_page['text']['page_settings_learndash']; ?></div>
					</div>
					<div class="uo-admin-block">
						<div class="uo-admin-form">
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="use_legacy_course_progress"
							...
							<div class="uo-admin-field">
								<label class="uo-checkbox">
									<input type="checkbox" name="ld_hide_courses_users_column"
				...
				<?php if ( Utilities::if_woocommerce_active() ) { ?>
					...
					<div class="uo-admin-section">
						<div class="uo-admin-header">
							<div class="uo-admin-title"><?php echo AdminPage::$ulgm_management_admin_page['text']['page_settings_ecommerce']; ?></div>
						</div>
						<div class="uo-admin-block">
							<div class="uo-admin-form">
								...
								<div class="uo-admin-field">
									<label class="uo-checkbox">
										<input type="checkbox" name="add_courses_as_part_of_license"
								...
								<div class="uo-admin-field">
									<label class="uo-checkbox">
										<input type="checkbox" name="add_groups_as_woo_products"
								...
								<div class="uo-admin-field">
									<label class="uo-checkbox">
										<input type="checkbox" name="ulgm_complete_group_license_orders"
								...
								<div class="uo-admin-field">
									...
									$j        = 0;
									?>
									<select name="ulgm_group_license_product_cat" class="uo-admin-select"
											id="ulgm_group_license_product_cat">
										<option value="">None</option>
										<?php foreach ( $terms as $term ) { ?>
											<option class="level-<?php echo $j; ?>" <?php echo absint( $default ) === absint( $term->term_id ) ? $selected : ''; ?>
								...
								<div class="uo-admin-field">
									...
									<input type="text" name="ulgm_add_to_cart_message" id="ulgm_add_to_cart_message"
				...
				<?php if ( Utilities::if_woocommerce_active() && Utilities::if_woocommerce_subscription_active() ) { ?>
					...
					<div class="uo-admin-section">
						<div class="uo-admin-header">
							<div class="uo-admin-title"><?php echo AdminPage::$ulgm_management_admin_page['text']['page_settings_woocommerce_subscriptions']; ?></div>
						</div>
						<div class="uo-admin-block">
							<div class="uo-admin-form">
								...
								<div class="uo-admin-field">
									<label class="uo-checkbox">
										<input type="checkbox" name="woo_subscription_allow_additional_seats"
								...
								<!-- Woocommerce Add To Cart Message -->
								<div class="uo-admin-field">
									<div class="uo-admin-label"><?php echo AdminPage::$ulgm_management_admin_page['text']['woo_subscription_allow_additional_seats_learn_more_link']; ?></div>

									<input type="text" name="woo_subscription_allow_additional_seats_learn_more_link" id="woo_subscription_allow_additional_seats_learn_more_link"
										   value="<?php echo get_option( 'woo_subscription_allow_additional_seats_learn_more_link', '' ); ?>"/>
									<div class="uo-admin-description"><?php _e( 'To direct Group Leaders to a page that explains the process to add seats to a subscription-based group, enter the URL of that instructional page. Leave the field blank to hide the Learn More button.', 'uncanny-learndash-groups' ); ?></div>
								</div>
								<!-- Submit -->
								<div class="uo-admin-field uo-admin-extra-space">
									<button id="btn-save_template"
				...
				<div class="uo-admin-section">
					...
					<div class="uo-admin-block">
						<div class="uo-admin-form">
							...
							<div class="uo-admin-field">
								<div class="uo-admin-description"><?php _e( 'To enable a Terms & Conditions checkbox on the Group Registration Form, enter text for the checkbox below. Does not apply if you are using a Gravity Form or Theme My Login for group registration.', 'uncanny-learndash-groups' ); ?></div>
							</div>
				...
				<div class="uo-admin-section" id="Upgrade-LearnDash-Groups">
					...
					<div class="uo-admin-block">
						<div class="uo-admin-form">
							<!-- Start process description -->
							<div class="uo-admin-field">
								<div class="uo-admin-description"><?php _e( 'All LearnDash Groups can be upgraded to include support for seat management by clicking the button below.', 'uncanny-learndash-groups' ); ?></div>
								<div class="uo-admin-description"><?php _e( '<span style="color:red">Warning:</span> Upgraded groups cannot be reverted to basic groups.  If you want to enable seat management on some groups only, use the Upgrade Group button on the Edit Group page.', 'uncanny-learndash-groups' ); ?></div>
							</div>
