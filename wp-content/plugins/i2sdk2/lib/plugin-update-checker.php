...
/*
 *	Includes fix for debug bar compatibility by David Bullock
 *
 *
 */
...
if ( ! class_exists( 'PluginUpdateChecker_1_4_Memberium' ) ):
	 ...
	 * @access public
	 */
	class PluginUpdateChecker_1_4_Memberium {
	...
	public function initDebugBarPanel() {
		if ( class_exists( 'Debug_Bar' ) ) {
			if ( file_exists( __DIR__ . '/debug-bar-plugin.php' ) ) {
				require_once __DIR__ . '/debug-bar-plugin.php';
...
PucFactory::addVersion( 'PluginUpdateChecker', 'PluginUpdateChecker_1_4_Memberium', '1.4' );
...
if ( !class_exists( 'PluginUpdateChecker' ) ) {
	class PluginUpdateChecker extends PluginUpdateChecker_1_4_Memberium { }
}
