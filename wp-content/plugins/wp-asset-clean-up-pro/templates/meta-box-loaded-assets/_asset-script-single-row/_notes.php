...
<div class="wpacu-handle-notes">
	...
	<div <?php if ($handleNote) { echo 'style="display: block;"'; } ?>
		data-script-handle="<?php echo htmlentities(esc_attr($data['row']['obj']->handle), ENT_QUOTES); ?>"
		class="wpacu-handle-notes-field">
                <textarea id="wpacu_handle_note_script_<?php echo htmlentities(esc_attr($data['row']['obj']->handle), ENT_QUOTES); ?>"
                          ...
                          name="wpacu_handle_notes[scripts][<?php echo htmlentities(esc_attr($data['row']['obj']->handle), ENT_QUOTES); ?>]"><?php echo esc_textarea($handleNote); ?></textarea>
	</div>
</div>