...
class grassblade_user_report {
	...
	function admin_user_report_menu() {
		add_submenu_page(null, null, null,'manage_options','grassblade_user_report', array($this, 'admin_user_report_page') );
	}
	...
	function user_report($attr){
		...
		if( empty($requested_user_id) || $requested_user_id == $current_user->ID || current_user_can("manage_options") || grassblade_is_group_leader_of_user($current_user->ID, $requested_user_id) ) {
