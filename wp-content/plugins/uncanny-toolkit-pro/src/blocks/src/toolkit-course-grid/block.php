...
register_block_type( 'uncanny-toolkit-pro/course-grid', [
	'attributes'      => [
		...
		'viewMoreText'           => [
			'type'    => 'string',
			'default' => esc_attr__( 'View more', 'uncanny-pro-toolkit' ) . ' <i class="fa fa fa-arrow-circle-right"></i>',
		],
		'viewLessText'           => [
			'type'    => 'string',
			'default' => esc_attr__( 'View less', 'uncanny-pro-toolkit' ) . ' <i class="fa fa fa-arrow-circle-right"></i>',
		],
		'categoryselector'       => [
			'type'    => 'string',
			'default' => 'hide',
...
function render_uo_course_grid( $attributes ) {
	...
	if ( class_exists( '\uncanny_pro_toolkit\ShowAllCourses' ) ) {
		$attributes['hideTitle'] = $attributes['hideTitle'] ? 'yes' : 'no';
		...
		echo \uncanny_pro_toolkit\ShowAllCourses::uo_courses( [
			...
			'hide_title'              => $attributes['hideTitle'],
