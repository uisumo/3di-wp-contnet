...
//  toggle_choices(check_box);  
  ...
  */
  ...
  <input type="checkbox" autocomplete="off" class="<?php echo $this->id ?>_map_enabled crm_map_enabled" id="vx_check_<?php echo $this->id ?>" name="crm_map_enabled" value="<?php echo $this->id ?>" /> <?php esc_html_e("Enable Infusionsoft Field Mapping?", 'gravity-forms-infusionsoft-crm'); ?>
  </label>
  
  <div id="<?php echo $this->id ?>_map_ui" style="display: none;">
  
  <label for="<?php echo $this->id ?>_map_type_live">
  <input type="radio" class="<?php echo $this->id ?>_map_type crm_map_type" id="<?php echo $this->id ?>_map_type_live" name="<?php echo $this->id ?>_map_type" value="live" /> <?php esc_html_e("Live Remote Field Mapping ", 'gravity-forms-infusionsoft-crm'); gform_tooltip("vx_map_live_".$this->id); ?>
  ...
  <input type="radio" class="<?php echo $this->id ?>_map_type crm_map_type" id="<?php echo $this->id ?>_map_type_once" name="<?php echo $this->id ?>_map_type" value="once" /> <?php esc_html_e("Only Populate Choices ", 'gravity-forms-infusionsoft-crm'); gform_tooltip("vx_map_once_".$this->id) ?>
