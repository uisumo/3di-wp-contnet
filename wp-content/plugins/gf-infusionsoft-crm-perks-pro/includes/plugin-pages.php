  ...
  */
  ...
  /**
    ...
    public function add_form_settings_menu( $tabs, $form_id ) {
        ...
        $tabs[] = array( 'name' => $this->id, 'label' => esc_html__("Infusionsoft", 'gravity-forms-infusionsoft-crm') , 'query' => array( 'fid' => null) );
...
$this->push($entry,$form,'add_note');
  ...
  */
  public  function setup(){
      ...
      RGForms::add_settings_page(array('name' => $this->id,'tab_label' => esc_html__('Infusionsoft','gravity-forms-infusionsoft-crm'),"handler"=>array($this, "settings_page")));
...
include_once(self::$path . "templates/feed-account.php");
  ...
  */
  ...
  array_push($form['fields'],array("id" => "date_created" , "label" => esc_html__("Entry Date", 'gravity-forms-infusionsoft-crm')));
  array_push($form['fields'],array("id" => "ip" , "label" => esc_html__("User IP", 'gravity-forms-infusionsoft-crm')));
  array_push($form['fields'],array("id" => "source_url" , "label" => esc_html__("Source Url", 'gravity-forms-infusionsoft-crm')));
  array_push($form['fields'],array("id" => "form_title" , "label" => esc_html__("Form Title", 'gravity-forms-infusionsoft-crm')));
