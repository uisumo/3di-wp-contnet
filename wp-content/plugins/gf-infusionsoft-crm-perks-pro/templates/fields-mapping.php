...
<div class="crm_clear"></div> 
  ...
  <?php esc_html_e('Disable Automatic Export', 'gravity-forms-infusionsoft-crm'); ?>
  ...
  <?php esc_html_e( 'Manually send the entries to Infusionsoft.', 'gravity-forms-infusionsoft-crm'); ?> </label>
  </fieldset>
  </div>
...
<div class="crm_clear"></div> 
  ...
  <?php echo $this->crm_select($s_fields,$meta['primary_key']); ?>
  </select> 
