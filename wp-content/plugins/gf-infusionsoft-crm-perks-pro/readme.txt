...
Gravity Forms infusionsoft Add-on sends Gravity Forms entries to infusionsoft/Keap CRM.
...
* Go to Forms -> select any form -> Settings -> Infusionsoft then create new feed.
* Map required Infusionsoft fields to Gravity Forms form fields.
