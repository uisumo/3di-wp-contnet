...
use IWLib\PhpXmlRpc\Helper\Charset;
use IWLib\PhpXmlRpc\Helper\Http;
use IWLib\PhpXmlRpc\Helper\Logger;
use IWLib\PhpXmlRpc\Helper\XMLParser;
...
class Request
{
    ...
    public function addParam($param)
    {
        ...
        if (is_object($param) && is_a($param, 'IWLib\PhpXmlRpc\Value')) {
            $this->params[] = $param;
