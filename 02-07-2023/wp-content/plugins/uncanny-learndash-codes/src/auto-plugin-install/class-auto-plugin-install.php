...
class Auto_Plugin_Install {
	...
	public function wp_ajax_auto_plugin_install() {
		...
		$data     = SharedFunctionality::ulc_filter_input_array( 'data', INPUT_POST, array(
	...
	public function get_file( $file_name = false, $sub_directory = false, $base_file = false ) {
		...
		$file = (object) array( 'success' => null, 'message' => '' );
		if ( false === $file_name ) {
			$file->success = false;
	 ...
	 * @return false|string
	 */
	public function button( $plugin_slug ) {
		...
		<div class="auto-plugin-install">
			<button class="uoc-generate-button auto-plugin-install-button"
