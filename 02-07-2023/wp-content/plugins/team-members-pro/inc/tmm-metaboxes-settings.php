 ...
 */
function dmb_tmmp_display_order_options()
{

	$options = array(
		__('Default', TMMP_TXTDM) => 'default',
		__('Random', TMMP_TXTDM)  => 'random'
	);
...
function dmb_tmmp_settings_display()
{
	...
	$team_display_order = dmb_tmmp_display_order_options();
...
<div class="dmb_settings_box dmb_sidebar">
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_first">
        <div class="dmb_field_title">
            <?php esc_html_e('Display order', TMMP_TXTDM) ?>
            <a class="dmb_inline_tip dmb_tooltip_small"
                data-tooltip="<?php esc_attr_e("Order in which your team members will be sorted when displayed.", TMMP_TXTDM) ?>">
                [?]
            </a>
        </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_first">
        <div class="dmb_field_title">
            ...
            <a class="dmb_inline_tip dmb_tooltip_medium"
                data-tooltip="<?php _e('Enabling this will give the same height to all the member boxes.', TMMP_TXTDM) ?>">[?]</a>
        </div>
        <select class="dmb_side_select" name="team_equalizer">
            <?php foreach ($team_equalizer as $label => $value) { ?>
            <option value="<?php echo $value; ?>"
                <?php selected((isset($settings['_tmm_equalizer'])) ? $settings['_tmm_equalizer'] : 'no', $value); ?>>
                <?php echo $label; ?></option>
            <?php } ?>
        </select>
    </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_last dmb_layout_select">
        ...
        <select class="dmb_side_select" name="team_picture_position">
            ...
            <option value="<?php echo $value; ?>"
                <?php selected((isset($settings['_tmm_picture_position'])) ? $settings['_tmm_picture_position'] : 'floating', $value); ?>>
                <?php echo $label; ?></option>
            <?php } ?>
        </select>
    </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_first">
        <div class="dmb_field_title">
            ...
            <a class="dmb_inline_tip dmb_tooltip_small"
                data-tooltip="<?php _e('The thickness of the member\'s top border in pixels (e.g. 5).', TMMP_TXTDM) ?>">[?]</a>
        </div>
        <input class="dmb_field dmb_tp_border_size_of_member" type="number" name="team_tp_border_size"
            value="<?php echo $settings['_tmm_tp_border_size']; ?>" placeholder="<?php _e('e.g. 5', TMMP_TXTDM) ?>" />
    </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_last">
        ...
        <select class="dmb_side_select" name="team_picture_filter">
            ...
            <option value="<?php echo $value; ?>"
                <?php selected((isset($settings['_tmm_picture_filter'])) ? $settings['_tmm_picture_filter'] : 'classic', $value); ?>>
                <?php echo $label; ?></option>
            <?php } ?>
        </select>
    </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_first dmb_picture_border_box">
        ...
        <select class="dmb_side_select" name="team_picture_border">
            ...
            <option value="<?php echo $value; ?>"
                <?php selected((isset($settings['_tmm_picture_border'])) ? $settings['_tmm_picture_border'] : 'yes', $value); ?>>
                <?php echo $label; ?></option>
            <?php } ?>
        </select>
    </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_last dmb_picture_shape_box">
        ...
        <select class="dmb_side_select" name="team_picture_shape">
            ...
            <option value="<?php echo $value; ?>"
                <?php selected((isset($settings['_tmm_picture_shape'])) ? $settings['_tmm_picture_shape'] : 'rounded', $value); ?>>
                <?php echo $label; ?></option>
            <?php } ?>
        </select>
    </div>
    ...
    <div class="dmb_grid dmb_grid_50 dmb_grid_first">
        <div class="dmb_field_title">
            ...
            <a class="dmb_inline_tip dmb_tooltip_medium"
                data-tooltip="<?php _e('This is the color scheme for the additional information toggle box.', TMMP_TXTDM) ?>">[?]</a>
        </div>
        <select class="dmb_side_select" name="team_comp_theme">
            <?php foreach ($team_comp_theme as $label => $value) { ?>
            <option value="<?php echo $value; ?>"
                <?php selected((isset($settings['_tmm_comp_theme'])) ? $settings['_tmm_comp_theme'] : 'dark', $value); ?>>
                <?php echo $label; ?></option>
            <?php } ?>
        </select>
    </div>
