		...
		plugin.methode = {
			...
			setCategoryOverview: function() {
				...
				$e.find( '.wpProQuiz_catOverview li' ).each( function() {
					var $this = $( this );
					var catId = $this.data( 'category_id' ); // cspell:disable-line

					if ( config.catPoints[catId] === undefined ) { // cspell:disable-line
						$this.hide();
						return true;
					}

					var r = Math.round( catResults[catId] / config.catPoints[catId] * 100 * 100 ) / 100; // cspell:disable-line
			...
			sortCategories: function() {
				var e = $( '.wpProQuiz_list' ).children().get().sort( function( a, b ) {
					...
					return config.json[aQuestionId].catId - config.json[bQuestionId].catId; // cspell:disable-line
				} );
