 ...
 *
 * Replaced by `learndash_is_quiz_accessable` in 3.4.0. // cspell:disable-line.
 *
 * @since 2.4.0
 *
 * @param int|null     $user_id   Optional. User ID. Default null.
 ...
 */
function learndash_is_quiz_accessable_legacy( $user_id = null, $post = null, $course_id = 0 ) { // cspell:disable-line.
	if ( empty( $user_id ) ) {
		$current_user = wp_get_current_user();
