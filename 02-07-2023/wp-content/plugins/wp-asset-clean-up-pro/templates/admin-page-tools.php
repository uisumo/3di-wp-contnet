        ...
        if ($data['for'] === 'debug') {
            ...
            <form method="post" action="">
                ...
                <ul>
                    ...
                    <li>Log PHP Errors Location: <code><?php echo esc_html($logPHPErrorsLocation); ?></code> <?php if ($logPHPErrorsLocationFileSize) { ?> / <?php _e('File Size', 'wp-asset-clean-up'); ?>: <?php echo wp_kses($logPHPErrorsLocationFileSizeFormatted, array('span' => array('style' => array(), 'class' => array()))); ?> &nbsp; <input style="vertical-align: middle;" type="submit" class="button button-primary" value="Download Error Log File" /><?php } ?></li>
                </ul>
