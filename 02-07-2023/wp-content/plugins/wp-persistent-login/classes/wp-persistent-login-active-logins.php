                ...
                if ( $this->reached_limit( $user_id ) === true ) {
                    ...
                    switch($limit_reached_logic) {
                        ...
                        case 'block' :
                            ...
                            $error = new WP_Error( '401', __( 'You have reached the maximum number of logins allowed at one time. Please log out of another device and try again.', WPPL_TEXT_DOMAIN ) );
