								...
								<tbody>
                                    ...
                                    <?php 
                                        ...
                                        $limit_reached_options = array(
                                            array(
                                                'label' => __('Automatically end the oldest active login for the user.', WPPL_TEXT_DOMAIN),
                                                'value' => 'automatic'
                                            ),
                                            array(
                                                'label' => __( 'Block new logins if active login limit reached.', WPPL_TEXT_DOMAIN ),
                                                'value' => 'block'
                                            )
                                        );
                                    ?>
                                    <tr style="border-bottom: 1px solid #dfdfdf;">
                                        <th>
                                            <?php _e('Limit reached logic', WPPL_TEXT_DOMAIN); ?><br/>
                                        </th>
                                        <td>
