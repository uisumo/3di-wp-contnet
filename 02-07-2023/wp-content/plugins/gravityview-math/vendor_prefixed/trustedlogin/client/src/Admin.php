...
EOD;
			$access_key_output   = sprintf(
				...
				/* %2$s */ esc_html__( 'Error', 'gk-gravitymath' ),
				/* %3$s */ 'div',
				/* %4$s */ esc_html__( 'There was an error returning the access key.', 'gk-gravitymath' ),
...
EOD;
			$access_key_output   = sprintf(
				$access_key_template,
				/* %1$s */ sanitize_title( $this->config->ns() ),
				/* %2$s */ esc_html__( 'Site access key:', 'gk-gravitymath' ),
				/* %3$s */ esc_html__( 'Access Key', 'gk-gravitymath' ),
				/* %4$s */ esc_attr( $access_key ),
				/* %5$s */ esc_html__( 'Copy', 'gk-gravitymath' ),
				/* %6$s */ 'div',
				/* %7$s */ esc_html__( 'Copy the access key to your clipboard', 'gk-gravitymath' ),
				// translators: %s is the display name of the TrustedLogin support user.
				/* %8$s */ sprintf( esc_html__( 'The access key is not a password; only %1$s will be able to access your site using this code. You may share this access key on support forums.', 'gk-gravitymath' ), $this->support_user->get_first()->display_name )
			);
