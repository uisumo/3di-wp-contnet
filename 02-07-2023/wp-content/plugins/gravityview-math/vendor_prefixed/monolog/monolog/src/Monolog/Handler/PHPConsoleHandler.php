...
namespace GravityKit\GravityMath\Monolog\Handler;

use Exception;
use GravityKit\GravityMath\Monolog\Formatter\LineFormatter;
use GravityKit\GravityMath\Monolog\Logger;
 ...
 *
 *      $logger = new \GravityKit\GravityMath\Monolog\Logger('all', array(new \GravityKit\GravityMath\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('GravityKit\\GravityMath\\Monolog\\'), // array Hide calls of classes started with...
