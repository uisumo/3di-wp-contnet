 ...
 */
namespace GravityKit\GravityMath\Katzgrau\KLogger;

use DateTime;
use RuntimeException;
use GravityKit\GravityMath\Psr\Log\AbstractLogger;
 ...
 *
 * Usage:
 * $log = new GravityKit\GravityMath\Katzgrau\KLogger\Logger('/var/log/', GravityKit\GravityMath\Psr\Log\LogLevel::INFO);
