...
use GFPDF_Vendor\League\Uri\UriTemplate\Template;
use GFPDF_Vendor\League\Uri\UriTemplate\VariableBag;
/**
...
final class UriTemplate
{
    ...
    {
        $this->template = \GFPDF_Vendor\League\Uri\UriTemplate\Template::createFromString($template);
     ...
     */
    private function filterVariables(array $variables) : \GFPDF_Vendor\League\Uri\UriTemplate\VariableBag
    {
        $output = new \GFPDF_Vendor\League\Uri\UriTemplate\VariableBag();
     ...
     */
    public function expand(array $variables = []) : \GFPDF_Vendor\League\Uri\Contracts\UriInterface
    {
        $uriString = $this->template->expand($this->filterVariables($variables)->replace($this->defaultVariables));
        return \GFPDF_Vendor\League\Uri\Uri::createFromString($uriString);
    }
}
