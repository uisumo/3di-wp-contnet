...
final class VariableBag
{
    ...
    private function normalizeValue($value, string $name, bool $isNestedListAllowed)
    {
        ...
        if (!$isNestedListAllowed) {
            throw \GFPDF_Vendor\League\Uri\Exceptions\TemplateCanNotBeExpanded::dueToNestedListOfValue($name);
        }
     ...
     */
    public function replace(\GFPDF_Vendor\League\Uri\UriTemplate\VariableBag $variables) : self
    {
        $instance = clone $this;
