...
class CurlHttpClient implements \GFPDF_Vendor\Mpdf\Http\ClientInterface, \Psr\Log\LoggerAwareInterface
{
    private $mpdf;
    private $logger;
    ...
    public function sendRequest(\Psr\Http\Message\RequestInterface $request)
    {
        ...
        \curl_close($ch);
        return $response->withStatus($info['http_code'])->withBody(\GFPDF_Vendor\Mpdf\Http\Stream::create($data));
    }
