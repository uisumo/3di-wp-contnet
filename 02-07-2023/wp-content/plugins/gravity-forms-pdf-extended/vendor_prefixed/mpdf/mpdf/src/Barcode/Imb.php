 ...
 */
class Imb extends \GFPDF_Vendor\Mpdf\Barcode\AbstractBarcode implements \GFPDF_Vendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
     * @param float $xDim
    ...
    public function __construct($code, $xDim, $gapWidth, $daft)
    {
        if (!\function_exists('bcadd')) {
            throw new \GFPDF_Vendor\Mpdf\Barcode\BarcodeException('IMB barcodes require bcmath extension to be loaded.');
        }
    ...
    private function init($code, $gapWidth, $daft)
    {
        ...
        switch (\strlen($routingCode)) {
            ...
            case 11:
                ...
                break;
            default:
                throw new \GFPDF_Vendor\Mpdf\Barcode\BarcodeException(\sprintf('Invalid MSI routing code "%s"', $routingCode));
        }
