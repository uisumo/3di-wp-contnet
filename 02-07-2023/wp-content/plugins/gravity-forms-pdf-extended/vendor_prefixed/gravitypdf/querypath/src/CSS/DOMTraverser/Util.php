...
class Util
{
     ...
     * @return bool
     */
    public static function matchesAttribute($node, $name, $value = null, $operation = \GFPDF_Vendor\QueryPath\CSS\EventHandler::IS_EXACTLY) : bool
    {
     ...
     */
    public static function matchesAttributeNS($node, $name, $nsuri, $value = null, $operation = \GFPDF_Vendor\QueryPath\CSS\EventHandler::IS_EXACTLY)
    {
