...
class Parser
{
     ...
     */
    public function __construct(string $string, \GFPDF_Vendor\QueryPath\CSS\EventHandler $handler)
    {
    ...
    {
        return \in_array($tok, [\GFPDF_Vendor\QueryPath\CSS\Token::PLUS, \GFPDF_Vendor\QueryPath\CSS\Token::RANGLE, \GFPDF_Vendor\QueryPath\CSS\Token::COMMA, \GFPDF_Vendor\QueryPath\CSS\Token::TILDE], \true);
    }
    /**
        ...
        if ($this->scanner->token === \GFPDF_Vendor\QueryPath\CSS\Token::LSQUARE) {
            ...
            switch ($this->scanner->token) {
                case \GFPDF_Vendor\QueryPath\CSS\Token::EQ:
                    $this->consumeWhitespace();
                    $op = \GFPDF_Vendor\QueryPath\CSS\EventHandler::IS_EXACTLY;
                    break;
                case \GFPDF_Vendor\QueryPath\CSS\Token::TILDE:
                    ...
                    $op = \GFPDF_Vendor\QueryPath\CSS\EventHandler::CONTAINS_WITH_SPACE;
                    break;
                case \GFPDF_Vendor\QueryPath\CSS\Token::PIPE:
                    if ($this->scanner->nextToken() !== \GFPDF_Vendor\QueryPath\CSS\Token::EQ) {
                        $this->throwError(\GFPDF_Vendor\QueryPath\CSS\Token::EQ, $this->scanner->token);
                    }
                    $op = \GFPDF_Vendor\QueryPath\CSS\EventHandler::CONTAINS_WITH_HYPHEN;
                    break;
                case \GFPDF_Vendor\QueryPath\CSS\Token::STAR:
                    if ($this->scanner->nextToken() !== \GFPDF_Vendor\QueryPath\CSS\Token::EQ) {
                        $this->throwError(\GFPDF_Vendor\QueryPath\CSS\Token::EQ, $this->scanner->token);
                    }
                    $op = \GFPDF_Vendor\QueryPath\CSS\EventHandler::CONTAINS_IN_STRING;
                    break;
                case \GFPDF_Vendor\QueryPath\CSS\Token::DOLLAR:
                    if ($this->scanner->nextToken() !== \GFPDF_Vendor\QueryPath\CSS\Token::EQ) {
                        $this->throwError(\GFPDF_Vendor\QueryPath\CSS\Token::EQ, $this->scanner->token);
                    }
                    $op = \GFPDF_Vendor\QueryPath\CSS\EventHandler::ENDS_WITH;
                    break;
                case \GFPDF_Vendor\QueryPath\CSS\Token::CARAT:
                    if ($this->scanner->nextToken() !== \GFPDF_Vendor\QueryPath\CSS\Token::EQ) {
                        $this->throwError(\GFPDF_Vendor\QueryPath\CSS\Token::EQ, $this->scanner->token);
                    }
                    $op = \GFPDF_Vendor\QueryPath\CSS\EventHandler::BEGINS_WITH;
                    break;
            }
            if (isset($op)) {
                // Consume '=' and go on.
     ...
     * @return Scanner
     */
    public function getScanner() : \GFPDF_Vendor\QueryPath\CSS\Scanner
    {
        return $this->scanner;
    }
}
