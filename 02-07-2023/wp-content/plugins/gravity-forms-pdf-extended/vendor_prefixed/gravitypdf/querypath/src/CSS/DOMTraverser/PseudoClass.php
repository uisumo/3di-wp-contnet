...
use GFPDF_Vendor\SPLObjectStorage;
/**
...
class PseudoClass
{
    ...
    public function elementMatches($pseudoclass, $node, $scope, $value = null)
    {
        ...
        switch ($name) {
            ...
            case 'nth-last-child':
                return $this->isNthChild($node, $value, \true);
            case 'nth-of-type':
                return $this->isNthChild($node, $value, \false, \true);
            case 'nth-last-of-type':
                return $this->isNthChild($node, $value, \true, \true);
            case 'first-of-type':
    ...
    protected function lang($node, $value)
    {
        ...
        $operator = \strpos($value, '-') !== \false ? \GFPDF_Vendor\QueryPath\CSS\EventHandler::IS_EXACTLY : \GFPDF_Vendor\QueryPath\CSS\EventHandler::CONTAINS_WITH_HYPHEN;
        $match = \true;
    ...
    protected function has($node, $selector) : bool
    {
        ...
        $splos->attach($node);
        $traverser = new \GFPDF_Vendor\QueryPath\CSS\DOMTraverser($splos, \true);
    ...
    {
        [$groupSize, $elementInGroup] = \GFPDF_Vendor\QueryPath\CSS\DOMTraverser\Util::parseAnB($value);
