 ...
 */
class FluentdFormatter implements \GFPDF_Vendor\Monolog\Formatter\FormatterInterface
{
    /**
    ...
    public function format(array $record) : string
    {
        ...
        return \GFPDF_Vendor\Monolog\Utils::jsonEncode([$tag, $record['datetime']->getTimestamp(), $message]);
    }
