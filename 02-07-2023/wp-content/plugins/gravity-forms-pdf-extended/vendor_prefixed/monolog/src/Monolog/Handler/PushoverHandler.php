...
class PushoverHandler extends \GFPDF_Vendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \GFPDF_Vendor\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \GFPDF_Vendor\Monolog\Logger::CRITICAL, $emergencyLevel = \GFPDF_Vendor\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
