 ...
 */
class Lzw implements \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\FilterInterface
{
    /**
     * @var null|string
     */
    ...
    public function decode($data)
    {
        if ($data[0] === "\0" && $data[1] === "\1") {
            throw new \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\LzwException('LZW flavour not supported.', \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\LzwException::LZW_FLAVOUR_NOT_SUPPORTED);
        }
        $this->initsTable();
        $this->data = $data;
