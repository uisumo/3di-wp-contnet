...
class AdminCreateGroup {
	...
	public function add_scripts() {
		...
		wp_enqueue_script( 'ulgm-select2', Utilities::get_vendor( 'select2/js/select2.min.js' ), [ 'jquery' ], Utilities::get_version(), true );
	...
	public static function enqueue_frontend_assets() {
		...
		if ( ! empty( $post ) ) {
			wp_enqueue_script( 'ulgm-frontend', Utilities::get_asset( 'frontend', 'bundle.min.js' ), [
				'jquery',
				'ulgm-select2',
			], Utilities::get_version(), true );
