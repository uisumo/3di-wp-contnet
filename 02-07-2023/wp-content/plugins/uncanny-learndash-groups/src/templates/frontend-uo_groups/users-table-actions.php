				...
				<div class="group-management-form">
					...
					<div class="uo-row">
						...
						<select
							...
							multiple="multiple"
						>
							<option value="not-enrolled" selected="selected">
								<?php _e( 'Not enrolled', 'uncanny-learndash-groups' ); ?>
							</option>

							<option value="not-started" selected="selected">
								<?php _e( 'Not Started', 'uncanny-learndash-groups' ); ?>
							</option>

							<option value="in-progress" selected="selected">
								<?php _e( 'In Progress', 'uncanny-learndash-groups' ); ?>
							</option>

							<option value="completed" selected="selected">
								<?php _e( 'Completed', 'uncanny-learndash-groups' ); ?>
							</option>
						</select>
