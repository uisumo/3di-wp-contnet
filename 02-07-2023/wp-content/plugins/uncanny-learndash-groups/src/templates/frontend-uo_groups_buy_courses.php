...
<form id="uo-groups-buy-courses" class="buy-courses-form" method="POST"
	...
	if ( $logic ) :
		...
		$args = apply_filters( 'ulgm_buy_courses_qry_args', array(
				'post_type'      => 'product',
				'orderby'        => 'title',
				'order'          => 'ASC',
				'posts_per_page' => 8888,
									...
									<div class="uo-groups-form-row--element">
										<input class="uo-input" type="text" value="<?php if ( ! empty( $group_name ) ) {
											echo $group_name;
											   ...
											   name="_custom_group_name" <?php if ( ! empty( $group_name ) ) { ?> disabled="disabled" <?php } ?>
											   required="required">
									</div>
								...
								<div class="uo-groups-form-row">
									...
									<div class="uo-groups-form-row--element">
										<input class="uo-input" type="number" value="<?php if ( $is_course_addition ) {
											echo get_post_meta( absint( ulgm_filter_input( 'group-id' ) ), '_ulgm_total_seats', true );
										} else {
											echo '1';
										} ?>" name="_custom_qty" id="uo-groups-buy-course-field-quantity" min="1"
											   required="required" <?php if ( $is_course_addition ) { ?> readonly="readonly" disabled="disabled" <?php } ?>>
									</div>
									<div class="uo-groups-form-row--comment">
