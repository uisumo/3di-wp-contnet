                    ...
                    <span class="ld-item-components">
                        ...
                        */
                        ...
                        if( $content_count['topics'] > 0 ): ?>
                            ...
                            <span class="ld-item-component"><?php echo esc_html( $content_count['topics'] . ' ' . _n( LearnDash_Custom_Label::get_label('topic'), LearnDash_Custom_Label::get_label('topics'), $content_count['topics'] ) ); ?> </span>
                        ...
                        if( $content_count['quizzes'] > 0 ): ?>
                            <span class="ld-item-component"><?php echo esc_html( $content_count['quizzes'] . ' ' . _n( LearnDash_Custom_Label::get_label('quiz'), LearnDash_Custom_Label::get_label('quizzes'), $content_count['quizzes'] ) ); ?></span>
                        <?php endif;
